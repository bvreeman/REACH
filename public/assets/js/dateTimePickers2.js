...
function loadDays(daysInMonth, booleanCurrentMonth) {
    ...
    if (!firstLoad) {
        ...
        $('#selectedDay').empty();
        let dayFirstOptionFormated = $('<option disabled value="" id="defaultYear" selected>');
...
function loadMonths(booleanCurrentYear) {
    ...
    if (!firstLoad) {
        ...
        monthVal = $('#selectedMonth').val();
        $('#selectedMonth').empty();
        let monthFirstOptionFormated = $('<option disabled value="" id="defaultMonth" selected>');
...
function loadHours(booleanCurrentDay) {
    if (!firstLoad) {
        ...
        $('#selectedHour').empty();
        let hourFirstOptionFormated = $('<option disabled value="" id="defaultHour" selected>');
...
function loadMinutes(booleanCurrentDayAndHour) {
    if (!firstLoad) {
        ...
        let minuteFirstOptionFormated = $('<option disabled value="" id="defaultMinute" selected>');
